...
class Mining_listing extends StatefulWidget {
  final int index;
  final String title;
  final List<Map<String, String>> businessCompanyProfile ;
  const Mining_listing({super.key,required this.index,required this.title,required this.businessCompanyProfile});
  @override
  State<Mining_listing> createState() => _Mining_listingState();
}

class _Mining_listingState extends State<Mining_listing> {
