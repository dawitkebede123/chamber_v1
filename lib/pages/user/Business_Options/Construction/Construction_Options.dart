...
class Construction_listing extends StatefulWidget {
  final int index;
  final String title;
  ...
  @override
  State<Construction_listing> createState() => _Agriculture_listingState();
}

class _Agriculture_listingState extends State<Construction_listing> {
